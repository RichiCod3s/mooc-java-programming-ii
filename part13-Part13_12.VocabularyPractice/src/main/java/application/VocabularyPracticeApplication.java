...
public class VocabularyPracticeApplication extends Application{
    ...
    // The practice application both unites the previously created classes and offers the main menu of the application. 
    private Dictionary dictionary;

    // Perform initialization tasks, such as loading resources or setting up data structures
    @Override
    ...
    public void start(Stage stage) throws Exception {
        ...
        // use the getView method to show the layouts of each class
